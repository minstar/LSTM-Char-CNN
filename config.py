...
flags.DEFINE_string('load_model', './train_dir/epoch24_4.884.model', 'If filename of model parameters is exist, then get the parameters')
...
flags.DEFINE_integer('total_train', 0, 'set to 1, if train set and validation set needs to be join together')
